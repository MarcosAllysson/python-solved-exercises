...
# Forma 1  - Importando qualquer o módulo (Não recomendado).

import random

# random() -> Gera um número real pseudo-aleatório entre 0 e 1.

# OBS: Ao realizar o import de qualquer o módulo, todas as funções, atributos, classes e propriedades que estiverem
